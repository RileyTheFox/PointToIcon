...
namespace PointToIcon
{
    ...
    /*
     * Tons of Win32 stuff happens in here. Do not ask me what it does I copy pasted it.
     * Although it shouldn't be too hard to figure out if you've messed with Win32 in C++ before.
     */
