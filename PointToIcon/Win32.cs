...
namespace PointToIcon
{
    ...
    /*
     * In here is basically just a bunch of wrappers and exposing Win32 API
     * functions that you'd be able to use normally in C++ by just including windows.h
     *  
     * Downloaded this, Desktop and DesktopPoint from some random site and it works perfectly. Thanks homie.
     */
